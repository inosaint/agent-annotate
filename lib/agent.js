...
Each note carries:
  ...
  shot     a PNG of the region the user dragged, relative to the store's directory.
           When a note has one, READ THAT IMAGE before deciding anything — it is
           what they were looking at, and it usually says what the words cannot.
           A note with a shot has no target or context: it is about whatever is in
           the picture, so look there first.
